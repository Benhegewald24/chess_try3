...
public class PawnMoves
{
    public void move(ChessBoard board, ChessPosition startPosition, ArrayList<ChessMove> moves)
    {
        ...
        if (rrow4 != 2 && board.getPiece(startPosition).getTeamColor() == WHITE) //White move 1 forward
        {
            ...
            if (board.getPiece(po6) != null && ccol4 < 9 && board.getPiece(po6).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow4 != 8) //White capture right
            {
                ChessMove mo6 = new ChessMove(startPosition, po6, null);
                moves.add(mo6);
            }

            if (board.getPiece(po6) != null && ccol4 < 9 && board.getPiece(po6).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow4 == 8) //White capture right with promotion
            {
                ChessMove mo22 = new ChessMove(startPosition, po6, BISHOP);
                moves.add(mo22);
                ChessMove mo23 = new ChessMove(startPosition, po6, KNIGHT);
                moves.add(mo23);
                ChessMove mo24 = new ChessMove(startPosition, po6, QUEEN);
                moves.add(mo24);
                ChessMove mo25 = new ChessMove(startPosition, po6, ROOK);
                moves.add(mo25);
            }

            ccol4-=2;
            ChessPosition po7 = new ChessPosition(rrow4, ccol4);
            if (board.getPiece(po7) != null && ccol4 > 0 && board.getPiece(po7).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow4 != 8) //White capture left
            {
            ...
            if (board.getPiece(po7) != null && ccol4 > 0 && board.getPiece(po7).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow4 == 8) //White capture left
            {
                ...
                moves.add(mo32);
                ChessMove mo33 = new ChessMove(startPosition, po7, KNIGHT);
                moves.add(mo33);
                ChessMove mo34 = new ChessMove(startPosition, po7, QUEEN);
                moves.add(mo34);
                ChessMove mo35 = new ChessMove(startPosition, po7, ROOK);
                moves.add(mo35);
            }
        }
        ...
        if (rrow5 != 7 && board.getPiece(startPosition).getTeamColor() == BLACK) //Black move 1 forward
        {
            ...
            if (board.getPiece(po6) != null && ccol5 < 9 && board.getPiece(po6).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow5 != 1) // Black capture right
            {
                ChessMove mo6 = new ChessMove(startPosition, po6, null);
                moves.add(mo6);
            }
            ...
            if (board.getPiece(po6) != null && ccol5 < 9 && board.getPiece(po6).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow5 == 1) // Black capture right
            {
                ...
                moves.add(mo52);
                ChessMove mo53 = new ChessMove(startPosition, po6, KNIGHT);
                moves.add(mo53);
                ChessMove mo54 = new ChessMove(startPosition, po6, QUEEN);
                moves.add(mo54);
                ChessMove mo55 = new ChessMove(startPosition, po6, ROOK);
                moves.add(mo55);
            }

            ccol5-=2;
            ChessPosition po7 = new ChessPosition(rrow5, ccol5);
            if (board.getPiece(po7) != null && ccol5 > 0 && board.getPiece(po7).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow5 != 1) //Black capture left
            {
                ChessMove mo7 = new ChessMove(startPosition, po7, null);
                moves.add(mo7);
            }
            ...
            if (board.getPiece(po7) != null && ccol5 > 0 && board.getPiece(po7).getTeamColor() != board.getPiece(startPosition).getTeamColor() && rrow5 == 1) //Black capture left
            {
                ...
                moves.add(mo52);
                ChessMove mo53 = new ChessMove(startPosition, po7, KNIGHT);
                moves.add(mo53);
                ChessMove mo54 = new ChessMove(startPosition, po7, QUEEN);
                moves.add(mo54);
                ChessMove mo55 = new ChessMove(startPosition, po7, ROOK);
                moves.add(mo55);
            }
        }
