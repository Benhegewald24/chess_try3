...
public class PawnMoves {
    public void move(ChessBoard board, ChessPosition startPosition, ArrayList<ChessMove> moves) {
        ...
        if (board.getPiece(po1) != null && rrow1 == 2 && board.getPiece(startPosition).getTeamColor() == WHITE) { //White starting position
            rrow1++;
        ...
        if (rrow4 != 2 && board.getPiece(startPosition).getTeamColor() == WHITE) //White move 1 forward
        {
            ...
            if (board.getPiece(po4) == null && rrow4 == 8) {
                ChessMove mo2 = new ChessMove(startPosition, po4, BISHOP); moves.add(mo2);
                ChessMove mo22 = new ChessMove(startPosition, po4, KNIGHT); moves.add(mo22);
                ChessMove mo32 = new ChessMove(startPosition, po4, QUEEN); moves.add(mo32);
                ChessMove mo42 = new ChessMove(startPosition, po4, ROOK); moves.add(mo42);
            }
            ...
            if (ccol4 < 9 && board.getPiece(po6) != null && board.getPiece(po6).getTeamColor()
                ...
                ChessMove mo22 = new ChessMove(startPosition, po6, BISHOP); moves.add(mo22);
                ChessMove mo23 = new ChessMove(startPosition, po6, KNIGHT); moves.add(mo23);
                ChessMove mo24 = new ChessMove(startPosition, po6, QUEEN); moves.add(mo24);
                ChessMove mo25 = new ChessMove(startPosition, po6, ROOK); moves.add(mo25);
            }
            ...
            if (ccol4 > 0 && board.getPiece(po7) != null && board.getPiece(po7).getTeamColor()
                    != board.getPiece(startPosition).getTeamColor() && rrow4 == 8) //White capture left
            {
                ChessMove mo32 = new ChessMove(startPosition, po7, BISHOP); moves.add(mo32);
                ChessMove mo33 = new ChessMove(startPosition, po7, KNIGHT); moves.add(mo33);
                ChessMove mo34 = new ChessMove(startPosition, po7, QUEEN); moves.add(mo34);
                ChessMove mo35 = new ChessMove(startPosition, po7, ROOK); moves.add(mo35);
            }
        }
        ...
        if (rrow5 != 7 && board.getPiece(startPosition).getTeamColor() == BLACK) { //Black move 1 forward
            ...
            if (board.getPiece(po5) == null && rrow5 == 1) {
                ChessMove mo42 = new ChessMove(startPosition, po5, BISHOP); moves.add(mo42);
                ChessMove mo43 = new ChessMove(startPosition, po5, KNIGHT); moves.add(mo43);
                ChessMove mo44 = new ChessMove(startPosition, po5, QUEEN); moves.add(mo44);
                ChessMove mo45 = new ChessMove(startPosition, po5, ROOK); moves.add(mo45);
            }
            ...
            if (ccol5 < 9 && board.getPiece(po6) != null && board.getPiece(po6).getTeamColor()
                    != board.getPiece(startPosition).getTeamColor() && rrow5 == 1) { // Black capture right
                ChessMove mo52 = new ChessMove(startPosition, po6, BISHOP); moves.add(mo52);
                ChessMove mo53 = new ChessMove(startPosition, po6, KNIGHT); moves.add(mo53);
                ChessMove mo54 = new ChessMove(startPosition, po6, QUEEN); moves.add(mo54);
                ChessMove mo55 = new ChessMove(startPosition, po6, ROOK); moves.add(mo55);
            }
            ...
            if (ccol5 > 0 && board.getPiece(po7) != null && board.getPiece(po7).getTeamColor()
                    != board.getPiece(startPosition).getTeamColor() && rrow5 == 1) { //Black capture left
                ChessMove mo52 = new ChessMove(startPosition, po7, BISHOP); moves.add(mo52);
                ChessMove mo53 = new ChessMove(startPosition, po7, KNIGHT); moves.add(mo53);
                ChessMove mo54 = new ChessMove(startPosition, po7, QUEEN); moves.add(mo54);
                ChessMove mo55 = new ChessMove(startPosition, po7, ROOK); moves.add(mo55);
            }
        }
