...
public class GameStatusTests {
    ...
    public void newGame() throws InvalidMoveException {
    ...
    public void noGameStatuses() throws InvalidMoveException {
        var game = new ChessGame();
    ...
    public void whiteCheck() throws InvalidMoveException {
        var game = new ChessGame();
    ...
    public void blackCheck() throws InvalidMoveException {
        var game = new ChessGame();
        game.setBoard(TestUtilities.loadBoard("""
                | | | |K| | | | |
                | | | | | | | | |
    ...
    public void escapeCheckByCapturingThreateningPiece() throws InvalidMoveException {
    ...
    public void cannotEscapeCheckByCapturingThreateningPiece() throws InvalidMoveException {
    ...
    public void checkmateWhereBlockingThreateningPieceOpensNewThreat() throws InvalidMoveException {
    ...
    public void checkmateNotStalemate() throws InvalidMoveException {
        var game = new ChessGame();
        game.setBoard(TestUtilities.loadBoard("""
                |k| | | | | | | |
                | | | | | | | | |
